    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('vendor/images/bg-01.jpg');">
            <div class="wrap-login100 text-center">
                <span class="text-white">Başarılı</span>
                <p class="text-white"><strong><?= $_SESSION['username'] ?></strong></p>
                <p class="text-white"><strong><?= $_SESSION['email'] ?></strong></p>
                <p class="text-white"><strong><?= $_SESSION['date'] ?></strong></p>
                <p class="text-white"><strong><?= $_SESSION['date_format'] ?></strong></p>
                <div class="container-login100-form-btn mt-2">
                    <form action="success.php" method="POST">
                        <button type="submit" class="login100-form-btn" name="exit">
                            Çıkış Yap
                        </button>
                    </form>
                </div>
